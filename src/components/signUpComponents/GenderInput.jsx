        ...
        <div className="form-group" id="grupo__genero">
            ...
            <div className="input-block">
                ...
                <label className="rad-label">
                    <input type="radio" className="rad-input gender" name="formGender" value="Masculino" onClick={onClick} />
                    <div className="rad-design rad-man"></div>
                    <div className="rad-text">Masculino</div>
                </label>

                <label className="rad-label">
                    <input type="radio" className="rad-input rad-woman gender" name="formGender" value="Femenino" onClick={onClick} />
                    <div className="rad-design rad-woman"></div>
                    <div className="rad-text">Femenino</div>
                </label>

                <label className="rad-label">
                    <input type="radio" className="rad-input rad-woman gender" name="formGender" value="Otro" onClick={onClick} />
